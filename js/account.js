const apiUrl = "http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders?api_key=c4574f8c-e4ac-48bb-89ef-c2febc3c55dc"; // URL API для получения заказов
let currentPage = 1; 
...
async function fetchCourseName(courseId) {
    ...
    const apiUrl = `http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders?api_key=c4574f8c-e4ac-48bb-89ef-c2febc3c55dc`;
...
async function showDetails(orderId) {
    const apiUrl = `http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders/${orderId}?api_key=c4574f8c-e4ac-48bb-89ef-c2febc3c55dc`;
...
async function editOrder(orderId) {
    ...
    try {
        ...
        const response = await fetch(`http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders/${orderId}?api_key=c4574f8c-e4ac-48bb-89ef-c2febc3c55dc`);
        if (!response.ok) {
...
async function saveOrderChanges(event) {
    ...
    try {
        ...
        const response = await fetch(`http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders/${orderIdToEdit}?api_key=c4574f8c-e4ac-48bb-89ef-c2febc3c55dc`, {
            method: "PUT",
...
async function deleteOrder() {
    ...
    try {
        ...
        const response = await fetch(`http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders/${orderIdToDelete}?api_key=c4574f8c-e4ac-48bb-89ef-c2febc3c55dc`, 
        { method: "DELETE" });
